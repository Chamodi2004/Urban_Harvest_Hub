...
function Workshops() {
  ...
  return (
    <main id="main-content" className="pt-32 pb-24 px-6 max-w-7xl mx-auto min-h-screen dark:text-white">
      {/* Header Section */}
      <div className="mb-10 text-center lg:text-left border-b border-gray-200/50 dark:border-gray-800/50 pb-6">
        <h1 className="text-4xl lg:text-5xl font-display font-extrabold text-ecoGreen dark:text-green-400">
          Educational Workshops
        </h1>
        <p className="mt-2 text-gray-650 dark:text-gray-400 text-base lg:text-lg max-w-xl">
